...
export function getQuickAnswer(input: string): QuickAnswer {
  ...
  if (/time|timeline|long|start|delivery|process/.test(question)) {
    return { answer: "Project timing depends on the scope, goals, and services involved. In a free consultation, the team can map the right approach and give you a realistic timeline.", suggestedPrompt: "How do I get started?" };
  }
